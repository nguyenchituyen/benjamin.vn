...
--
-- Host: 127.0.0.1    Database: benjamin
-- ------------------------------------------------------
...
CREATE TABLE `dtb_product_class` (
  ...
  `classcategory_id1` int(11) DEFAULT NULL,
  `classcategory_id2` int(11) DEFAULT NULL,
  `product_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `stock` decimal(10,0) DEFAULT NULL,
  `main_price` decimal(10,0) DEFAULT NULL,
  `price01` decimal(10,0) DEFAULT NULL,
  `price02` decimal(10,0) DEFAULT NULL,
  `start_from_discount` datetime DEFAULT NULL,
  `endt_to_discount` datetime DEFAULT NULL,
  `rate_discount` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `dtb_products` (
  ...
  `image6` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `main_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sub_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `main_comment` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sub_comment` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `point_rate` decimal(10,0) DEFAULT NULL,
  `product_flag` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `del_flg` smallint(6) DEFAULT NULL,
  `creator_id` int(11) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  `update_date` datetime DEFAULT NULL,
  `shop_id` int(11) DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'admin','admin@gmail.com','$2y$10$dL8bDbvik3Xwu7WqAhMcl.ORbhlC0TSAuFa90/432dJQCqRlItvMW','AvNK66yn7ys3ChMhsAQzYVzz6CpaB1HjdVIRQOK32SqQ2o9pMA9jTsldkJZa','2017-06-21 20:58:15','2017-06-21 20:58:15');
...
-- Dump completed on 2017-06-22 17:11:22
